...
// Version 3/23/00
// Modified by IZ, 12/2001: to work with VML/SVG switcher, and take care of IE5+ and NN6
...
//		document.writeln('<font color="#FFFFFF"><p align="center">To view this page you need an SVG viewer.</p></font>');
//		document.writeln('<font color="#FFFFFF"><p align="center"><a href="'+getSVGInstallPage()+'">Click here</a> for more information.</p></font>');
		}
	else
...
//	document.writeln('<font color="#FFFFFF"><p align="center">To view this page you need an SVG viewer. There is currently no Adobe SVG ');
//	document.writeln('Viewer available for your browser. </p></font>');
//	document.writeln('<font color="#FFFFFF"><p align="center"><a href="'+svgInfoPage+'">Click here</a> for more information.</p></font>');
	}
}
